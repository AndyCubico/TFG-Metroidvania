...
public class AnimationManager : MonoBehaviour
{
    ...
    void AnimatePlayer()
    {
        ...
        if (characterPlayerController.playerState != PLAYER_STATUS.CROUCH)
        {
            ...
            if ((characterPlayerController.rb.linearVelocity.x > 0.1f || characterPlayerController.move.x != 0) && characterPlayerController.move.y == 0 && characterPlayerController.playerState == PLAYER_STATUS.GROUND && characterPlayerController.playerState != PLAYER_STATUS.DASH)
            {
